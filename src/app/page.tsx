        ...
        <div className="flex flex-wrap items-center w-full">
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Link
                href="/timer"
                className="shadow-solid-primary w-full md:w-auto px-4 py-2 align-end md:px-6 md:py-2 font-black text-lg rounded-md border border-2 border-primary cursor-pointer ease-in-out duration-300 hover:-translate-y-1"
              >
                Get Started
              </Link>
            </div>
